...
import { departmentNavigationItems, registrarNavigationItems } from "@/lib/navigation-data";

interface DepartmentNavigationGroupsProps {
  searchQuery: string;
}

export function DepartmentNavigationGroups({
  searchQuery,
}: DepartmentNavigationGroupsProps) {
  ...
  const filteredItems = departmentNavigationItems
    .map((group) => ({
      ...group,
