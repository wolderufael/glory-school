...
export function HeroSection() {
  const stats = [
    ...
    { icon: Award, label: "National Exam Result Success Rate", value: "95%" },
        ...
        >
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            <p className="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Inspiring excellence, character, and lifelong learning. Empowering
              every student to achieve and lead.
            </p>
          </motion.div>
