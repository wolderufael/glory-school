...
import { registrarNavigationItems } from "@/lib/navigation-data";

interface RegistrarNavigationGroupsProps {
  searchQuery: string;
}

export function RegistrarNavigationGroups({
  searchQuery,
}: RegistrarNavigationGroupsProps) {
  ...
  const filteredItems = registrarNavigationItems
    .map((group) => ({
      ...group,
