  ...
  return (
    <Sidebar className="border-r border-blue-200">
      <SidebarHeader className="border-b border-blue-200 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-blue-100">Registrar Portal</span>
          </div>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent className="bg-white">
        ...
        <RegistrarNavigationGroups searchQuery={searchQuery} />
      </SidebarContent>
              ...
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton className="hover:bg-blue-100">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-sm font-medium">Admin Registrar</span>
                    <span className="text-xs text-gray-500">REG/2024/01</span>
                  </div>
