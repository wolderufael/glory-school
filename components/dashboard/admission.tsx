...
import { GraduationCap, ArrowLeft, CheckCircle, Clock, List } from "lucide-react"
  ...
  const admissionSteps = [
    {
      step: 1,
      title: "Application",
      description: "Complete the in-person application form with your personal and academic information",
      status: "active",
    },
    {
      step: 2,
    ...
    },
    {
      ...
      description: "View the admission results and accept your offer",
      status: "pending",
    },
    {
      step: 4,
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <p className="text-white text-lg font-medium">Check your current admission progress</p>
              </div>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-br from-green-600 to-green-700 text-white">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-green-100">
                    ...
                    <li>• Entrance Result</li>
                    <li>• 9–12 Transcripts</li>
                  </ul>
                </CardContent>
              </Card>
            </motion.div>
