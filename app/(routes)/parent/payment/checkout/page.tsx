...
const PaymentIcons = {
  telebirr: (
    <Image src="/tellebirr.png" alt="Telebirr" width={20} height={20} />
  ),
...
const CheckoutPageContent = () => {
  ...
  const selectedStudent =
    demoChildren.find((c) => c.id === studentId) || demoChildren[0];

  // Get selected months data
  const selectedMonths = selectedStudent.feeMonths.filter((month) =>
        ...
        <Card className="max-w-md w-full text-center">
          ...
          <CardContent>
            <p className="mb-6 text-slate-600">
              We couldn't find the payment details. Please go back and select
              months to pay.
            </p>
        ...
        <div className="flex justify-between items-center mb-10 relative">
          ...
          <div className="flex flex-col items-center z-10">
            ...
            >
              <span
                className={`text-lg font-bold ${
                  isConfirmed ? "text-white" : "text-slate-500"
                }`}
              >
                3
              </span>
