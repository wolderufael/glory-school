...
const PaymentPageContent = () => {
  ...
  useMemo(() => {
    ...
    const currentMonthData = selectedStudent.feeMonths.find(
      (m) =>
        m.id ===
  ...
  const handleCheckout = () => {
    ...
    router.push(
      `/parent/payment/checkout?studentId=${selectedStudentId}&months=${selectedMonths.join(
        ","
                    ...
                    >
                      ...
                      <TableCell>
                        ...
                        {month.status === "overdue" && (
                          <div className="text-xs text-rose-500">Past due</div>
                        )}
                      </TableCell>
                      <TableCell>
                        {month.dueDate ? (
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div>
                      ...
                      <p className="text-blue-600">
                        {selectedMonths.length} months selected • Total: ETB{" "}
